...
import { useServiceWorker, useCurrentFn, useStatic, useServiceWorkerContainerEvent } from "@motajs/react-hooks";
...
const MainView: FC = () => {
  ...
  useServiceWorkerContainerEvent(navigator.serviceWorker, "message", (e) => {
