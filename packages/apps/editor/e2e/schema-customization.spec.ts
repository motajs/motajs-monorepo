...
async function enterAndInspectTable(page: Page, panel: Locator, nodeId: string): Promise<void> {
...
for (const current of cases)
  test(`${current.name} exposes non-writing inline customization`, async ({ page }) => {
