...
const fixtures: Array<[string, Record<string, unknown>]> = [
  ...
  [
    'showImage',
    { type: 'showImage', code: 1, image: 'bg.jpg', reverse: 'x', loc: [10, 20], opacity: 0.8, time: 300, async: true },
  ],
  [
    'showImage cropped',
    {
  ...
  [
    'moveImage mode',
    { type: 'moveImage', code: 2, to: ['flag:x', 20], opacity: 0.6, moveMode: 'easeIn', time: 500, async: true },
  ],
  ...
  [
    'screenFlash move mode',
    { type: 'screenFlash', color: [255, 255, 255, 0.5], time: 100, times: 3, moveMode: 'easeInOut', async: true },
  ],
  ...
  [
    'moveTextBox complete',
    { type: 'moveTextBox', code: 2, loc: ['flag:x', 20], relative: true, moveMode: 'easeIn', time: 500, async: true },
  ],
  ...
  [
    'setBlockFilter',
    { type: 'setBlockFilter', loc: [1, 2], blur: 1, hue: 120, grayscale: 0.4, invert: true, shadow: 2 },
  ],
  ...
  [
    'moveEnemyOnPoint absolute',
    { type: 'moveEnemyOnPoint', from: [1, 2], to: [3, 4], floorId: 'sample0', norefresh: true },
  ],
  ...
  [
    'rotateImage',
    { type: 'rotateImage', code: 1, center: [100, 120], moveMode: 'easeIn', angle: -90, time: 500, async: true },
  ],
  [
    'scaleImage',
    { type: 'scaleImage', code: 1, center: [100, 120], moveMode: 'easeOut', scale: 0.8, time: 300, async: true },
  ],
  ...
  [
    'strokeEllipse',
    { type: 'strokeEllipse', x: 100, y: 100, a: 80, b: 40, angle: 30, style: [255, 255, 255, 1], lineWidth: 2 },
  ],
  ['fillArc', { type: 'fillArc', x: 100, y: 100, r: 50, start: 0, end: 90, style: [255, 255, 255, 1] }],
  [
    'strokeArc',
    { type: 'strokeArc', x: 100, y: 100, r: 50, start: 0, end: 90, style: [255, 255, 255, 1], lineWidth: 2 },
  ],
  ['drawImage', { type: 'drawImage', image: 'bg.jpg', reverse: 'x', x: 0, y: 0, w: 320, h: 240, angle: 15 }],
  [
    'drawImage cropped',
    { type: 'drawImage', image: 'bg.jpg', x: 0, y: 0, w: 32, h: 32, x1: 100, y1: 100, w1: 64, h1: 64, angle: 10 },
  ],
];
