...
export function assertMapMatrixSize(matrix: MapMatrix, options: ParseMapMatrixOptions): void {
...
export function parseMapMatrixText(text: string, options: ParseMapMatrixOptions = {}): MapMatrix {
