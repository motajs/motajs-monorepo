...
export type CheckboxSetOpen = (
  options: CheckboxSetOptions,
...
export function CheckboxSetModalActionProvider({
  open,
  children,
}: {
  open: CheckboxSetOpen;
  children: ReactNode;
}) {
  return (
    <CheckboxSetModalContext.Provider value={open}>
      {children}
    </CheckboxSetModalContext.Provider>
  );
}
