...
export type SelectPointOpen = (
  options: SelectPointOptions,
) => Promise<SelectPointResult | null>;
...
export function SelectPointModalActionProvider({
  open,
  children,
}: {
  open: SelectPointOpen;
  children: ReactNode;
}) {
  return (
    <SelectPointModalContext.Provider value={open}>
      {children}
    </SelectPointModalContext.Provider>
  );
}
