...
function rectSchema(eventType: 'fillRect' | 'strokeRect'): BlockSchema {
  ...
  const args: NonNullable<BlockSchema['definition']['args0']> = [
    { type: 'field_input', name: 'X', text: '0' },
    { type: 'field_input', name: 'Y', text: '0' },
    { type: 'field_input', name: 'WIDTH', text: 'flag:x' },
    { type: 'field_input', name: 'HEIGHT', text: '300' },
    { type: 'field_input', name: 'RADIUS', text: '' },
  ...
  return uiSchema(
    ...
    args,
    [
      field('X', 'x', { valueType: 'expression', optional: false }),
      field('Y', 'y', { valueType: 'expression', optional: false }),
      field('WIDTH', 'width', { valueType: 'expression', optional: false }),
      field('HEIGHT', 'height', { valueType: 'expression', optional: false }),
      field('RADIUS', 'radius', { valueType: 'expression' }),
      field('ANGLE', 'angle', { valueType: 'expression' }),
      field('STYLE', 'style', { valueType: 'colour' }),
...
export const drawIconSchema = uiSchema(
  ...
  [
    ...
    { type: 'field_number', name: 'FRAME', value: 0, min: 0, precision: 1 },
    { type: 'field_input', name: 'X', text: '0' },
    { type: 'field_input', name: 'Y', text: '0' },
    { type: 'field_input', name: 'WIDTH', text: '' },
    { type: 'field_input', name: 'HEIGHT', text: '' },
  ...
  [
    ...
    field('FRAME', 'frame', { valueType: 'number', default: 0, omitWhenDefault: true }),
    field('X', 'x', { valueType: 'expression', optional: false }),
    field('Y', 'y', { valueType: 'expression', optional: false }),
    field('WIDTH', 'width', { valueType: 'expression' }),
    field('HEIGHT', 'height', { valueType: 'expression' }),
...
export const drawBackgroundSchema = uiSchema(
  ...
  [
    { type: 'field_input', name: 'BACKGROUND', text: 'winskin.png' },
    { type: 'field_colour', name: 'BACKGROUND_COLOUR', colour: '#ffffff' },
    { type: 'field_input', name: 'X', text: '0' },
    { type: 'field_input', name: 'Y', text: '0' },
    { type: 'field_input', name: 'WIDTH', text: '100' },
    { type: 'field_input', name: 'HEIGHT', text: '100' },
  ],
  [
...
export const drawSelectorSchema = uiSchema(
  ...
  [
    field('IMAGE', 'image', { valueType: 'string' }),
    field('CODE', 'code', { valueType: 'number', optional: false }),
    field('X', 'x', { valueType: 'expression' }),
    field('Y', 'y', { valueType: 'expression' }),
    field('WIDTH', 'width', { valueType: 'expression' }),
    field('HEIGHT', 'height', { valueType: 'expression' }),
...
export const setHeroIconSchema: BlockSchema = {
  ...
  definition: {
    type: 'mota_setHeroIcon_s',
    message0: '更改角色行走图 %1 不重绘 %2',
    args0: [
      { type: 'field_input', name: 'NAME', text: 'hero.png' },
      { type: 'field_checkbox', name: 'NO_DRAW', checked: false },
    ],
    inputsInline: true,
    previousStatement: null,
    nextStatement: null,
  ...
  category: 'data',
  event: {
    match: { path: 'type', equals: 'setHeroIcon' },
    template: { type: 'setHeroIcon' },
    bindings: [
      field('NAME', 'name', { valueType: 'string' }),
      field('NO_DRAW', 'noDraw', { valueType: 'boolean', default: false, omitWhenDefault: true }),
    ],
  },
  interactions: [
    {
